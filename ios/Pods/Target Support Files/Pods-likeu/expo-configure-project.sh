...
with_node \
  ...
  --target "/Users/ki/Desktop/likeu/ios/Pods/Target Support Files/Pods-likeu/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-camera" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-router" "expo-system-ui" "expo-web-browser"
